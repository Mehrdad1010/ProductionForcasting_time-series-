...
class data_prepear:
    ...
    def creator(self):
        ...
        trget_index = np.array(self.df[self.df["AVG_CHOKE_SIZE_P"]>self.filter_value].index)
        elements_to_remove = np.array([693, 694, 695, 696, 697, 698, 699, 700])
        trget_index = trget_index[~np.isin(trget_index, elements_to_remove)]
