...
class data_prepear:
    ...
    def creator(self):
        ...
        length_train = int(len(series_X)*0.8)
        X_train = series_X.iloc[:length_train :]
        y_train = y.iloc[:length_train :]
        X_test = series_X.iloc[length_train: :]
        y_test = y.iloc[length_train: :]
